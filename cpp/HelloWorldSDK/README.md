...
To successfully run this example, an ArmoniK cluster with a partition for the dynamic C++ worker provided by the SDK.
If you already deployed ArmoniK and wish to add such a partition, you might follow these steps:   
...
## Building and runnig the example
...
## Notes:
- Ensure that you replace http://xxx.xxx.xxx:5001 with the correct endpoint for your control plane.
